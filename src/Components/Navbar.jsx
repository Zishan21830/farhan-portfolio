...
const Navbar = () => {
  ...
  return (
    <nav className="h-16 w-full flex justify-between items-center xs:px-4 md:px-20 py-2 bg-black overflow-x-hidden">
      {/* logo */}
      ...
      {/* features */}
        <ul className={`${mobileMenu ? 'block' : 'hidden'} xs:absolute xs:top-20 xs:rounded-md xs:right-4 xs:bg-black xs:px-10 xs:py-3 xs:h-3/4 ${mobileMenu ? 'w-3/5' : ''} md:flex md:p-0 md:right-0 md:relative md:top-0 gap-10 font-poppins text-white md:text-lg z-50`}>
